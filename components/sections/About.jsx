  ...
  return (
    <section className="relative bg-gradient-to-b from-cyan-white via-[#CCFF02] to-white px-6 md:px-12 py-24 rounded-2xl mb-12">
      ...
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-black leading-relaxed">
          I’ve been{" "}
        ...
        {/* Sub Text */}
        <p className="mt-8 text-base sm:text-lg text-gray-700 max-w-2xl mx-auto">
      ...
      <div className="mt-20 flex flex-col md:flex-row items-center justify-center gap-8 flex-wrap">
