    ...
    >
      ...
      <div className="px-3 md:px-6 lg:px-12 mb-20 md:mb-32">
        ...
        <div className="mb-10 md:mb-16 px-2 md:px-8">
          <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-black font-black leading-tight md:leading-relaxed ${fontBold.className}`}>
            Trusted{" "}
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-0">
          ...
          <div className="md:-rotate-90 flex md:flex-col items-center md:items-start gap-4 md:gap-0">
            <h3 className={`text-xl md:text-2xl mb-0 md:mb-8 ${fontReg.className} `}>@williamrey</h3>
          ...
          <div className="md:w-1/2 lg:w-5/12">
            <p className={`text-base md:text-lg font-medium mb-6 md:mb-10 ${fontReg.className} `}>
      ...
      <WhyChooseMe fontReg={fontReg} fontBold={fontBold} />
    </div>
  );
};
